...
START TRANSACTION;
USE `megahjaya2`;
INSERT INTO `megahjaya2`.`company_info` (`id`, `name`, `address`, `telp`, `logo_path`, `logo_title_path`, `taxpayer_reg_number`, `owner`, `currency_id`) VALUES (1, 'Your Company Name', 'Your Company Address', '-', NULL, NULL, 'Your Company Tax Reg. Number', 'Your Company Owner', NULL);
